    ...
    <div class="col-lg-12">
        <div class="form-group">
            ...
            <select id="lce_id" name="lce_id" class="form-control" required>
                @if(isset($fta)&&isset($fta['lce']))
                    <option value="{{$fta['lce']['lce_id']}}" selected>{{$fta['lce']['fullname']}}</option>
                @endif
            </select>
        </div>
    </div>
    ...
    <div class="col-lg-4">
       <div class="form-group">
        ...
        <div class="input-group mb-3">
            ...
            name="prov_code" id="prov_code" @if(isset($fta)&&isset($fta['lce']['province'])) value="{{$fta['lce']['province']['prov_desc']}}"  @endif disabled required>
        </div>
       </div>
    </div>
    ...
    <div class="col-lg-4">
        <div class="form-group">
            ...
            <div class="input-group mb-3">
                ...
                name="muncit_id" id="muncit_id" @if(isset($fta)&&isset($fta['lce']['muncit'])) value="{{$fta['lce']['muncit']['muncit_desc']}}" @else value="{{$fta['lce']['province']['prov_desc']}}"  @endif disabled required>
            </div>
        </div>
    </div>
        ...
        <div class="form-group">
            <div class="form-group">
                ...
                <div class="input-group mb-3">
                    ...
                    name="designation" id="designation" @if(isset($fta)&&isset($fta['lce'])) value="{{$fta['lce']['designation']}}"  @endif disabled required>
                </div>
            </div>
        </div>
    </div>
            ...
            <label for="datefrom">{{__('Date From')}}</label>
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control datepicker" id="datefrom" placeholder="{{__('Date From')}}"
                     name="datefrom" required @if(isset($fta)&&isset($fta['lce'])) value="{{$fta['datefrom']}}"  @endif>
                </div>
        ...
        <div class="form-group">
            <label for="dateto">{{__('Date To')}}</label>
                <div class="input-group mb-3">
                    ...
                    name="dateto" required @if(isset($fta)&&isset($fta['lce'])) value="{{$fta['dateto']}}"  @endif>
                </div>
