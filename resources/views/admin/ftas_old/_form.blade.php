    ...
    <div class="col-lg-4">
       <div class="form-group">
        ...
        <div class="input-group mb-3">
            ...
            name="prov_code" id="prov_code" @if(isset($fta)&&isset($fta['lce'])) value="{{$fta['lce']['prov_code']}}"  @endif disabled required>
        </div>
       </div>
    </div>
    ...
    <div class="col-lg-4">
        <div class="form-group">
            ...
            <div class="input-group mb-3">
                ...
                name="muncit_id" id="muncit_id" @if(isset($fta)&&isset($fta['lce']['muncit_id'])) value="{{$fta['lce']['muncit_id']}}"  @endif disabled required>
            </div>
        </div>
    </div>
