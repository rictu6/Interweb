        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <div class="form-group">
                    ...
                    {{-- @can('create_section')
                    <button type="button" class="btn btn-warning btn-sm float-right" data-toggle="modal"
                        data-target="#section_modal"><i class="fa fa-exclamation-triangle"></i>
                        {{__('Not Listed ?')}}</button>
                    @endcan --}}
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="password" class="form-control" placeholder="{{__('Password')}}" name="password_hash" @if(!isset($user)) required @endif>


                </div>
                <label for="password_hash">{{__('Password')}}</label>
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <span class="input-group-text">
                    ...
                    <input type="password" class="form-control" placeholder="{{__('Password Confirmation')}}" id="password_confirmation" name="password_confirmation" @if(!isset($user)) required @endif>
