...
<div class="form-group">
    <div class="row">
      ...
      <div class="col-lg-12">
    <label for="sub_allotment_no">{{__('Sub-Allotment')}}</label>
        <input type="text" class="form-control" name="sub_allotment_no" placeholder="{{__('Sub-Allotment No')}}"  required>
      </div>
  ...
  <div class="col-lg-12">
   ...
   <div class="col-lg-12">
    <div class="form-group">
         <label for="remarks">{{__('Purpose')}}</label>

         <textarea name="remarks" id="remarks" rows="3" class="form-control" placeholder="{{__('Purpose')}}">{{old('remarks')}}</textarea>
